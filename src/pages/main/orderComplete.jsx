    ...
    return (
        <div style={styles.container}>
            <div style={styles.content}>
                <h1 className='text-xl font-bold'>CONGRATS, ORDER <span className='text-violet-700 italic'>COMPLETE!</span></h1>
                <p className='text-center'>You'll hear from the Seller soon....<br></br>Thank You</p>
