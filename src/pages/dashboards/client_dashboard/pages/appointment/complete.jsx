        ...
        <>
            ...
            <Dialog className='rounded-[20px]' open={open} onClose={handleClose}>
                ...
                <DialogActions>
                    ...
                    <Button onClick={handleClose} className='w-full btn bg-violet-600 text-white hover:bg-green-600 hover:text-white md:ml-4 font-semibold px-3 py-2 rounded-[10px] duration-500'>
                        Confirm
                    </Button>
                </DialogActions>
            </Dialog>
